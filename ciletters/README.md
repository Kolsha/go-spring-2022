...
В реализации нужно подогнать `text/template` шаблон под требуемый вывод. Функция должна использовать *один* шаблон. Использовать 
fmt.Sprintf или конкатенецию строк - нельзя.
